...
def plot_spectro_from_pipeline():

    bebop_file= "AudioSpectro/bebop/B_S2_D1_067-bebop_000_.wav.npy"
    bebop_audio = np.load(bebop_file)
    plt.figure(figsize=(7, 5))
    librosa.display.specshow(bebop_audio,
                             sr=16000,
                             hop_length=256,
                             x_axis="time",
                             y_axis="log")
    ...
    plt.colorbar(format="%+2.f")
    plt.title("log spectro bebop")
    plt.show()

    membo_file = "AudioSpectro/membo/extra_membo_D2_2000.wav.npy"
    membo_audio = np.load(membo_file)
    plt.figure(figsize=(7, 5))
    librosa.display.specshow(membo_audio,
                             sr=16000,
                             hop_length=256,
                             x_axis="time",
                             y_axis="log")
    ...
    unknown_file = "AudioSpectro/unknown/1-137-A-320.wav.npy"
    unknown_audio = np.load(unknown_file)
    plt.figure(figsize=(7, 5))
    librosa.display.specshow(unknown_audio,
                             sr=16000,
                             hop_length=256,
                             x_axis="time",
                             y_axis="log")
